...
export class ProductDetailsComponent {
  prodDetails: any;
  prodId: any;
  // myProduct: any = [1,2,3,5,4,5];
  // myProduct: any =localStorage.getItem("myPr")?JSON.parse(localStorage.getItem("myPr"|null)):[ ];
  ...
  products: Array<Products> = [
    {
      ...
      title: 'iPhone 9',
      description:
        'An apple mobile which is nothing like apple which is nothing like apple',
      price: 549,
